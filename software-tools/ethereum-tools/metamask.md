...
You can use both the Metamask browser plugin, or the Metamask mobile app if you want. We will show instruction for the browser plugin: for the mobile app the configuration is very similar.
