...
![](../../../.gitbook/assets/one_click_fig6%20%281%29.png)
...
### Download and Install nRF Connect for Windows <a id="download-and-install-nrf-connect-for-windows"></a>
...
![](../../../.gitbook/assets/one_click_fig1.png)

Double-click the downloaded executable file \(e.g., `nrfconnect-setup-3.6.0-ia32.exe`\) and complete the installation.

### Install the Nordic Toolchain Manager app <a id="install-the-nordic-toolchain-manager-app"></a>
...
![](../../../.gitbook/assets/one_click_fig2.png)

### Download and install the Pebble SDK package <a id="download-and-install-the-pebble-sdk-package"></a>
...
![](../../../.gitbook/assets/one_click_fig3.png)
...
### Open and configure the Embedded Studio IDE <a id="open-and-configure-the-embedded-studio-ide"></a>
...
![](../../../.gitbook/assets/one_click_fig4.png)
...
![](../../../.gitbook/assets/one_click_fig6.png)

### Build the Application Firmware <a id="build-pebble-application-firmware"></a>

#### Build in Embedded Studio IDE <a id="build-in-embedded-studio-ide"></a>
...
![](../../../.gitbook/assets/one_click_fig5.png)
