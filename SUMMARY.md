...
* [Pebble Tracker](verifiable-data/pebble-tracker/README.md)
  ...
  * [Firmware Development](verifiable-data/pebble-tracker/firmware-development/README.md)
    ...
    * [Setup modes](verifiable-data/pebble-tracker/firmware-development/setup-modes/README.md)
      * [Development mode](verifiable-data/pebble-tracker/firmware-development/setup-modes/development-mode/README.md)
        * [Deploy the backend service](verifiable-data/pebble-tracker/firmware-development/setup-modes/development-mode/deploy-the-backend-service.md)
        * [Send data to the backend](verifiable-data/pebble-tracker/firmware-development/setup-modes/development-mode/send-data-to-the-backend.md)
      * [Production mode](verifiable-data/pebble-tracker/firmware-development/setup-modes/production-mode/README.md)
        * [Configure AWS IoT Core](verifiable-data/pebble-tracker/firmware-development/setup-modes/production-mode/configure-aws-iot-core.md)
        * [Send data to AWS IoT Core](verifiable-data/pebble-tracker/firmware-development/setup-modes/production-mode/send-data-to-aws-iot-core.md)
    * [Develop and Build the Firmware](verifiable-data/pebble-tracker/firmware-development/develop-and-build-the-firmware/README.md)
      * [Build on Windows](verifiable-data/pebble-tracker/firmware-development/develop-and-build-the-firmware/build-on-windows.md)
      * [Build on Linux/macOS](verifiable-data/pebble-tracker/firmware-development/develop-and-build-the-firmware/build-on-linux-macos.md)
      * [Configure the firmware](verifiable-data/pebble-tracker/firmware-development/develop-and-build-the-firmware/configure-the-firmware.md)
    * [Flashing the firmware](verifiable-data/pebble-tracker/firmware-development/flashing-the-firmware/README.md)
      * [Application firmware](verifiable-data/pebble-tracker/firmware-development/flashing-the-firmware/application-firmware.md)
      * [Bootloader firmware](verifiable-data/pebble-tracker/firmware-development/flashing-the-firmware/bootloader-firmware.md)
