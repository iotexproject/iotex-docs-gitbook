...
## 🧑‍💻MachineFi Development <a href="#layer2" id="layer2"></a>

* [W3bStream Network](layer2/w3bstream-network/README.md)
  * [Roles in W3bStream](layer2/w3bstream-network/roles-in-w3bstream.md)
  * [Communication Patterns](layer2/w3bstream-network/communication-patterns.md)
  * [Device Binding / Unbinding](layer2/w3bstream-network/device-binding-unbinding.md)
  * [W3bStream Node Lifecycle](layer2/w3bstream-network/w3bstream-node-lifecycle.md)
* [MachineFi Workflow](layer2/machinefi-workflow/README.md)
  * [IoT Device Onboarding](layer2/machinefi-workflow/iot-device-onboarding.md)
  * [Node Onboarding](layer2/machinefi-workflow/node-onboarding.md)
  * [MachineFi Dapp Launching](layer2/machinefi-workflow/machinefi-dapp-launching.md)
* [Web2-Based Devices](layer2/web2-based-devices/README.md)
  * [Proxy-based Pattern](layer2/web2-based-devices/proxy-based-pattern.md)
  * [W3bStream SDK](layer2/web2-based-devices/w3bstream-sdk.md)
  * [Device Binding](layer2/web2-based-devices/device-binding.md)
  * [Data - Proofs - APIs](layer2/web2-based-devices/data-proofs-apis.md)
* [Web3 Devices](layer2/web3-devices/README.md)
  * [Pebble Tracker](layer2/web3-devices/pebble-tracker/README.md)
    * [Overview](layer2/web3-devices/pebble-tracker/overview.md)
    * [Quick Start](layer2/web3-devices/pebble-tracker/quick-start.md)
    * [Firmware update](layer2/web3-devices/pebble-tracker/firmware-update.md)
    * [Network selection](layer2/web3-devices/pebble-tracker/network-selection.md)
    * [Data Endpoints](layer2/web3-devices/pebble-tracker/endpoints.md)
    * [Firmware Development](layer2/web3-devices/pebble-tracker/firmware-development/README.md)
      * [Technical Specification](layer2/web3-devices/pebble-tracker/firmware-development/technical-specification.md)
      * [Hardware Setup](layer2/web3-devices/pebble-tracker/firmware-development/hardware-setup.md)
      * [Develop and Build the Firmware](layer2/web3-devices/pebble-tracker/firmware-development/develop-and-build-the-firmware/README.md)
        * [Build on Windows](layer2/web3-devices/pebble-tracker/firmware-development/develop-and-build-the-firmware/build-on-windows.md)
        * [Build on Linux/macOS](layer2/web3-devices/pebble-tracker/firmware-development/develop-and-build-the-firmware/build-on-linux-macos.md)
        * [Configure the firmware](layer2/web3-devices/pebble-tracker/firmware-development/develop-and-build-the-firmware/configure-the-firmware.md)
      * [Flashing the firmware](layer2/web3-devices/pebble-tracker/firmware-development/flashing-the-firmware/README.md)
        * [Application firmware](layer2/web3-devices/pebble-tracker/firmware-development/flashing-the-firmware/application-firmware.md)
        * [Bootloader firmware](layer2/web3-devices/pebble-tracker/firmware-development/flashing-the-firmware/bootloader-firmware.md)
  * [Custom Devices](layer2/web3-devices/custom-devices.md)
