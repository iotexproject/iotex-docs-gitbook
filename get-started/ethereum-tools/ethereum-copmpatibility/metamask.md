...
Connecting **Metamask** to the IoTeX blockchain is as easy as adding a new network in Metamask settings and configure it using the IoTeX testnet or mainnet **Babel** endpoint. 
...
You can use both the Metamask browser plugin or the Metamask mobile app if you want. We will show instructions for the browser plugin: for the mobile app, the configuration is very similar.
